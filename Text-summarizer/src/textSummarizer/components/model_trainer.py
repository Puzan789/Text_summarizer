...
class ModelTrainer:
    ...
    def train(self):
        ...
        small_train_dataset = dataset_sum_pt["test"] # First 2 examples from test dataset
        small_eval_dataset = dataset_sum_pt["validation"]# First 2 examples from validation dataset
